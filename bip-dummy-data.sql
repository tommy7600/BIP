...
(1, 1, 1, 1, 1, 1, 1, 12345678, 1, 12345679);
...
INSERT INTO `galleries_revisions` (`id`, `gallery_id`, `title_id`, `global_revision`, `author_id`, `date`, `approved_by_id`, `approval_date`) VALUES
(1, 1, 1, 0, 1, 12345678, 1, 12345679);
...
(1, 'test@test.com', 'xylem', '1234', 0, NULL);
